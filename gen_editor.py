...
DEST = pathlib.Path(r'f:\Projects\fastapi_bookings\frontend\src\components\ui\weekly-schedule-editor.tsx')
...
DEST.write_text('\n'.join(lines) + '\n', encoding='utf-8')
print('Written', DEST.stat().st_size, 'bytes, lines:', len(lines))
