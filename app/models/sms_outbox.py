...
class SmsOutboundJob(Base):
    ...
    def __repr__(self) -> str:
        return f"<SmsOutboundJob id={self.id} tenant_id={self.tenant_id} message_id={self.message_id} status={self.status}>"
...
class SmsAiJob(Base):
    ...
    def __repr__(self) -> str:
        return f"<SmsAiJob id={self.id} tenant_id={self.tenant_id} conversation_id={self.conversation_id} status={self.status}>"
...
class SmsConversationEvent(Base):
    ...
    def __repr__(self) -> str:
        return f"<SmsConversationEvent id={self.id} tenant_id={self.tenant_id} conversation_id={self.conversation_id} type={self.type}>"
...
class SmsNote(Base):
    ...
    def __repr__(self) -> str:
        return f"<SmsNote id={self.id} tenant_id={self.tenant_id} conversation_id={self.conversation_id} author_id={self.author_id}>"
